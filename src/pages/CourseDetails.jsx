...
const CourseDetails = () => {
  ...
  const courseData = {
    ...
    10: {
      ...
      certificate: true,
      curriculum: [
        { title: "Introduction to Renewable Energy", duration: "2 weeks", lessons: 8 },
        { title: "Solar Photovoltaic Systems", duration: "3 weeks", lessons: 12 },
        { title: "Solar Thermal Systems", duration: "2 weeks", lessons: 8 },
        { title: "Wind Energy Fundamentals", duration: "3 weeks", lessons: 12 },
        { title: "Wind Turbine Design & Analysis", duration: "2 weeks", lessons: 10 },
        { title: "Energy Storage Systems", duration: "2 weeks", lessons: 8 },
        { title: "Grid Integration & Smart Grids", duration: "2 weeks", lessons: 8 },
        { title: "Energy Policy & Sustainability", duration: "1 week", lessons: 4 },
        { title: "Renewable Energy Project Design", duration: "3 weeks", lessons: 12 },
        { title: "Capstone Project", duration: "2 weeks", lessons: 8 }
      ],
      skills: ["Solar PV Design", "Wind Turbine Analysis", "Energy Storage", "Grid Integration", "AutoCAD", "Energy Auditing", "Sustainability Analysis", "Project Feasibility Studies", "Renewable Energy Policy", "System Simulation"],
      requirements: ["Basic physics and mathematics", "Interest in sustainable energy", "Computer with internet"],
      features: ["Hands-on system design projects", "Industry case studies", "Site visit simulations", "Mentorship from energy professionals", "Job placement assistance"]
    },
    11: {
      ...
      certificate: true,
      curriculum: [
        { title: "Engineering Drawing & Drafting", duration: "2 weeks", lessons: 8 },
        { title: "SolidWorks Fundamentals", duration: "3 weeks", lessons: 14 },
        { title: "Advanced Part & Assembly Modeling", duration: "3 weeks", lessons: 12 },
        { title: "Sheet Metal & Weldment Design", duration: "2 weeks", lessons: 8 },
        { title: "GD&T and Tolerance Analysis", duration: "2 weeks", lessons: 8 },
        { title: "Finite Element Analysis with ANSYS", duration: "3 weeks", lessons: 12 },
        { title: "Thermal & Structural Simulation", duration: "2 weeks", lessons: 8 },
        { title: "Product Development Process", duration: "2 weeks", lessons: 8 },
        { title: "Design for Manufacturing (DFM)", duration: "1 week", lessons: 6 },
        { title: "Capstone Design Project", duration: "3 weeks", lessons: 12 }
      ],
      skills: ["SolidWorks", "ANSYS", "CAD Modeling", "GD&T", "Finite Element Analysis", "Product Development", "Machine Design", "Design for Manufacturing", "Assembly Design", "Technical Documentation"],
      requirements: ["Basic engineering mechanics", "Familiarity with mathematics", "Computer with internet"],
      features: ["Hands-on SolidWorks & ANSYS labs", "Real product design projects", "Industry mentorship", "Portfolio of CAD designs", "Job placement assistance"]
    },
    12: {
      ...
      certificate: true,
      curriculum: [
        { title: "Manufacturing Processes Overview", duration: "2 weeks", lessons: 8 },
        { title: "CNC Programming & Machining", duration: "3 weeks", lessons: 12 },
        { title: "3D Printing & Additive Manufacturing", duration: "2 weeks", lessons: 10 },
        { title: "Industry 4.0 & Smart Factories", duration: "2 weeks", lessons: 8 },
        { title: "Quality Control & Six Sigma", duration: "2 weeks", lessons: 8 },
        { title: "Production Planning & Lean Manufacturing", duration: "2 weeks", lessons: 8 },
        { title: "Automation & Robotics in Manufacturing", duration: "2 weeks", lessons: 8 },
        { title: "Supply Chain & Operations Management", duration: "1 week", lessons: 4 },
        { title: "Manufacturing Capstone Project", duration: "2 weeks", lessons: 8 }
      ],
      skills: ["CNC Machining", "3D Printing", "Industry 4.0", "Lean Manufacturing", "Six Sigma", "Production Planning", "Automation", "Quality Control", "Process Optimization", "Robotics Basics"],
      requirements: ["Basic engineering fundamentals", "Interest in production systems", "Computer with internet"],
      features: ["Hands-on CNC & 3D printing labs", "Industry 4.0 case studies", "Factory simulation projects", "Industry mentorship", "Job placement assistance"]
    }
  }
